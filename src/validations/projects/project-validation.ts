// src/validations/projects/project-validation.ts
import { z } from 'zod';
...
export type IProjectFormSchema = z.input<typeof createProjectSchema>;

export type IProjectFormOutput = z.output<typeof createProjectSchema>;
