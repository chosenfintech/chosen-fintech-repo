// src/components/events/categories/data-table/Filters.tsx
'use client';
...
interface IEventCategoryTableFiltersProps {
  table: Table<IEventCategory>;
  filters: Omit<ICategoriesQueryParams, 'page' | 'limit'>;
  onFiltersChange: (
    filters: Partial<Omit<ICategoriesQueryParams, 'page' | 'limit'>>,
  ) => void;
  totalCount: number;
  onCreateEventCategory: () => void;
  onDeleteSelected: () => void;
}

export function EventCategoryTableFilters({
  table,
  filters,
  onFiltersChange,
  totalCount,
  ...
  onDeleteSelected,
}: IEventCategoryTableFiltersProps) {
