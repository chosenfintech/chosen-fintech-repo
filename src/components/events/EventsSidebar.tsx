// src/components/events/EventsSidebar.tsx
'use client';
...
interface BlogSidebarProps {
  ...
  searchQuery?: string;
  onEventCategoryFilter: (categoryId: string | null) => void;
...
function EventCategoryButton({
  cat,
  isSelected,
  onEventCategoryFilter,
}: {
  cat: IEventCategory;
  isSelected: boolean;
  onEventCategoryFilter: (id: string | null) => void;
}) {
    ...
    <div className="flex flex-col gap-2">
      ...
      {categories.map((cat, index) => (
        ...
        >
          <EventCategoryButton
            cat={cat}
            isSelected={selectedEventCategory === cat.id}
            onEventCategoryFilter={onEventCategoryFilter}
          />
        </motion.div>
      ))}
    </div>
...
const RecentEventsList = ({ recentEvents }: RecentEventsListProps) => (
          ...
          <DrawerContent>
            <div className="mx-auto w-full max-w-sm">
              <DrawerHeader className="text-left">
                ...
                <DrawerDescription>
                  Narrow down events by category.
                </DrawerDescription>
              </DrawerHeader>
