// src/components/projects/preview/ContentDisplay.tsx
import Image from 'next/image';
import { FileText, Image as ImageIcon } from 'lucide-react';
import { IProject } from '@/types/projects/project.types';

interface IProjectContentDisplayProps {
  project: IProject;
}

export default function ProjectContentDisplay({ project }: IProjectContentDisplayProps) {
  return (
