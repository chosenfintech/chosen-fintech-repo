...
import { IGuideFormSchema } from '@/validations/guides/guide-validation';
import { IGuide, GUIDE_LEVELS } from '@/types/guides/guide.types';
...
interface IGuideFormProps {
  form: UseFormReturn<IGuideFormSchema>;
  onSubmit: (data: IGuideFormSchema) => Promise<void>;
  isLoading: boolean;
  initialData?: IGuide | null;
  mode: 'create' | 'update';
}
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <p className="text-sm text-muted-foreground">
                        This will appear in guide previews and search results
                      </p>
                    </FormItem>
                  )}
                />
                      ...
                      render={({ field }) => (
                        <FormItem className="flex flex-row items-start space-x-3 space-y-0 bg-white dark:bg-slate-800 p-4 rounded-lg border border-slate-200 dark:border-slate-600">
                          ...
                          <div className="space-y-1 leading-none">
                            ...
                            <p className="text-sm text-muted-foreground">
                              Make this guide visible to readers
                            </p>
                          </div>
                        </FormItem>
                      )}
