// src/components/guides/detail/ShareMenu.tsx
'use client';
...
export const ShareMenu: React.FC<ShareMenuProps> = ({ guideTitle }) => {
  ...
  const shareOptions = [
    ...
    },
    {
      ...
      icon: Mail,
      action: () => {
        const subject = encodeURIComponent(`Check out: ${guideTitle}`);
