// src/components/guides/preview/ContentDisplay.tsx
import Image from 'next/image';
import { FileText, Image as ImageIcon } from 'lucide-react';
import { IGuide } from '@/types/guides/guide.types';

interface IGuideContentDisplayProps {
  guide: IGuide;
}

export default function GuideContentDisplay({ guide }: IGuideContentDisplayProps) {
  return (
