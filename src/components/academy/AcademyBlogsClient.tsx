// src/components/academy/AcademyBlogsClient.tsx
'use client';
...
export interface IAcademyBlogsClientProps {
  posts: IPost[];
  recentPosts: IPost[];
...
export default function AcademyBlogsClient({
  posts,
  recentPosts,
  categories,
  totalPages,
