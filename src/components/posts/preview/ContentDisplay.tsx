// src/components/posts/preview/ContentDisplay.tsx
import Image from 'next/image';
import { FileText, Image as ImageIcon } from 'lucide-react';
import { IPost } from '@/types/posts/post.types';

interface IPostContentDisplayProps {
  post: IPost;
}

export default function PostContentDisplay({ post }: IPostContentDisplayProps) {
  return (
