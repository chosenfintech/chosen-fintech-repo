// src/components/users/data-table/Filters.tsx
'use client';
import * as React from 'react';
import { Table } from '@tanstack/react-table';
import { ChevronDown, Trash2, Search, X, Plus } from 'lucide-react';
...
import { IUser, IUsersQueryParams } from '@/types/user.types';
    ...
    <div className="space-y-4">
      ...
      <div className="flex gap-3">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent
            align="end"
            className="w-50 bg-popover text-popover-foreground"
          >
            <div className="p-2">
        ...
        {hasFiltersApplied && (
          <Button
            ...
            className="h-11 text-destructive hover:bg-destructive/10 hidden sm:flex shrink-0"
          >
            Clear all
          </Button>
        )}
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          {filters.search && (
            ...
            >
              ...
              <span className="max-w-37.5 sm:max-w-50 truncate">
                {filters.search}
              </span>
              <Button
                variant="ghost"
